...
public class SelectionVendingState implements VendingState {
    public SelectionVendingState(){
    ...
    public void chooseProduct(VendingMachine machine, int codeNumber) throws Exception{
        ...
        if(paidByUser < item.getPrice()) {
            ...
            machine.setVendingMachineState(new DispenseVendingState(machine, codeNumber));
        }
    }
