...
public class GovtJobObservable implements JobVacancyObservable{
    ...
    public void notifyObservers() {
        for(VacancyAlertObserver observer : observerArrayList){
            if(observer instanceof EmailObserver emailObserver){
                ...
                System.out.println("Whats New: "+this.getJobOpenings()+" Government Job Openings available\n\n");
            }
        }
    }
